  ...
  return(
    <div className="footer">
      ...
      <span className="social-icons">
        <a href="https://www.instagram.com/p.lucky__official"><img src={ig} alt="instagram"/></a>
        <a href="https://www.youtube.com/channel/UCee6mxIZsuwynoxdpuZa8zg"><img src={yt} alt="youtube"/></a>
        <a href="https://open.spotify.com/artist/2LBJr3uzzw5jg2ngbh2PpC"><img src={sp} alt="spotify"/></a>
        <a href="https://music.apple.com/us/artist/p-lucky/1512324079"><img src={it} alt="apple music"/></a>
        <a href="https://soundcloud.com/user-771075733"><img src={sc} alt="soundcloud"/></a>
      </span>
      <p></p>
